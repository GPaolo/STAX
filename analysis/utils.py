...
from core.population import Archive, Population, Grid
import re
import math
...
def make_gradient(width, height, x, y, a, b, theta):
  """
  This function draws an ellipse with a gradient
  :param width:
  :param height:
  :param h:
  :param k:
  ...
  y, x = np.mgrid[-y:height - y, -x:width - x]
