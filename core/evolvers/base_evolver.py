...
class BaseEvolver(object):
  ...
  def __init__(self, parameters, **kwargs):
    ...
    self.indpb = self.params.mutation_parameters['mut_prob']
    ...
    self.evaluation_budget = self.params.evaluation_budget
  ...
  def mutate_genome(self, genome):
    ...
    return genome.clip(self.params.genome_limit[0], self.params.genome_limit[1])
